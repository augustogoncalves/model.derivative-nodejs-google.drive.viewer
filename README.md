...
[![Viewer](https://img.shields.io/badge/Viewer-v3-green.svg)](http://developer.autodesk.com/)

# Description

This sample use [Model Derivative API](https://developer.autodesk.com/en/docs/model-derivative/v2/overview/) to translate [Google Drive](https://drive.google.com) files into [Viewer](https://developer.autodesk.com/en/docs/viewer/v2/overview/). It loads 2 files and color-code the differences: green (added), red (deleted) and orange (modified). See [this blog post](https://forge.autodesk.com/blog/comparing-versions-viewer) for more information. Based on [this sample](https://github.com/Autodesk-Forge/model.derivative-nodejs-google.drive.viewer).
...
See it live at [forgegoogledriveviewerchanges.herokuapp.com](http://forgegoogledriveviewerchanges.herokuapp.com). 
